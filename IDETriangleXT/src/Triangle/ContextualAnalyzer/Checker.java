...
import Triangle.AbstractSyntaxTrees.LoopBody;
...
public final class Checker implements Visitor {
    ...
    public Object visitRecDeclaration(RecDeclaration aThis, Object o) {
        aThis.proc.visit(this, o);
        //recAux((ProcFuncs) aThis.proc, o);
        //recAux2((ProcFuncs) aThis.proc);
    ...
    public Object visitProcFuncs(ProcFuncs aThis, Object o) {
        ...
        if (aThis.declaration instanceof ProcDeclaration) {
            ProcDeclaration ast = (ProcDeclaration) aThis.declaration;
            idTable.enter(ast.I.spelling, ast); // permits recursion
            if (ast.duplicated) {
                reporter.reportError("identifier \"%\" already declared",
                        ast.I.spelling, ast.position);
        ...
        } else if (aThis.declaration instanceof FuncDeclaration) {
            FuncDeclaration ast = (FuncDeclaration) aThis.declaration;
            ast.T = (TypeDenoter) ast.T.visit(this, null);
            idTable.enter(ast.I.spelling, ast); // permits recursion
            if (ast.duplicated) {
                reporter.reportError("identifier \"%\" already declared",
            ...
            if(aThis.procFunc1 != null){
                if (aThis.procFunc1 instanceof ProcDeclaration) {
            ProcDeclaration ast = (ProcDeclaration) aThis.procFunc1;
            idTable.enter(ast.I.spelling, ast); // permits recursion
            if (ast.duplicated) {
                reporter.reportError("identifier \"%\" already declared",
                        ast.I.spelling, ast.position);
            ...
            idTable.openScope();
            ast.FPS.visit(this, o);
        } else if (aThis.procFunc1 instanceof FuncDeclaration) {
            FuncDeclaration ast = (FuncDeclaration) aThis.procFunc1;
            ast.T = (TypeDenoter) ast.T.visit(this, null);
            idTable.enter(ast.I.spelling, ast); // permits recursion
            if (ast.duplicated) {
                reporter.reportError("identifier \"%\" already declared",
            ...
            aThis.declaration.visit(this,o);
        }
            }
        }
    ...
    public Object visitProcFunc(ProcFunc aThis, Object o) {
        if (aThis.D instanceof ProcDeclaration) {
            ((ProcDeclaration) aThis.D).visit(this, o);
        } else if (aThis.D instanceof FuncDeclaration) {
            ((FuncDeclaration) aThis.D).visit(this, o);
        }
