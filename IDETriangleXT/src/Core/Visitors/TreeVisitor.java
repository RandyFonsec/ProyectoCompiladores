...
public class TreeVisitor implements Visitor {
    ...
    public Object visitIfCommand(IfCommand ast, Object obj) {
        if(ast.orbody != null){
            return(createQuaternary("If Command", ast.E, ast.C1, ast.orbody, ast.C2));
        }else{
    ...
    @Override
    public Object visitOrBody(OrBody ast, Object o) {
        if(ast.orBody == null){
            return (createBinary("| Condition ", ast.expression, ast.command));
        }else{
            return (createTernary("| Condition ", ast.expression, ast.command, ast.orBody));
        }
    }
    
    public Object visitWhileBody(WhileBody ast, Object obj) {
        return(createBinary("While loop ", ast.E, ast.C));
    }


    @Override
    public Object visitLoopCommand(LoopCommand aThis, Object o) {
        return(createUnary("Loop command", aThis.lb));
    }

    @Override
    public Object visitUntilBody(UntilBody ast, Object object) {
        return (createBinary("Until loop ", ast.E, ast.C));
    }

    @Override
    public Object visitDoBody(DoBody ast, Object o) {
        return (createBinary("Do loop ", ast.C, ast.E));
    }

    @Override
    public Object visitForBody(ForBody ast, Object o) {
        if(ast.E3 != null)
            return ((createQuinary("For Loop", ast.I, ast.E1, ast.E2, ast.E3, ast.C)));
        else
            return ((createQuaternary("For Loop", ast.I, ast.E1, ast.E2, ast.C)));
    }
